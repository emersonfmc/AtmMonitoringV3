                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select id="userTypeSelect" name="user_type" class="form-select select2_dropdown">
                        ...
                        <div class="col-md-4">
                            ...
                            <span id="DistrictDisplay" style="display: none;">
                                ...
                                <div class="form-group mb-2">
                                    ...
                                    <select id="district_id" name="district_id" class="form-select select2">
                                ...
                                <div class="form-group mb-2">
                                    ...
                                    <select id="district_session_id" name="district_session_id" class="form-select select2">
                            ...
                            <span id="AreaDisplay" style="display: none;">
                                ...
                                <div class="form-group mb-2">
                                    ...
                                    <select id="district_manager_io" name="district_manager_io" class="form-select select2">
                                ...
                                <div class="form-group mb-2">
                                    ...
                                    <select id="area_supervisor_id" name="area_supervisor_id" class="form-select select2">
                                ...
                                <div class="form-group mb-2">
                                    ...
                                    <select id="district_area_id" name="district_area_id" class="form-select select2">
                            ...
                            <span id="BranchDisplay" style="display: none;">
                                ...
                                <div class="form-group mb-2">
                                    <label class="fw-bold h6">User Group</label>
                                    <select id="user_group_branch_id" name="user_group_branch_id" class="form-select select2">
                                        <option value="" selected disabled>Select User Type</option>
                                        @foreach ($user_groups as $user_group)
                                            <option value="{{ $user_group->id }}">{{ $user_group->group_name }}</option>
                                        @endforeach
